...
SPAM_PROMPT = """Ты модератор бухгалтерского сайта. Определи, является ли комментарий рекламой или спамом.

Спам/реклама — это:
- Упоминание конкретной компании, сервиса, продукта с целью продвижения
- Предложение услуг (бухгалтерское обслуживание, аутсорсинг, юридические услуги и т.п.)
- Ссылки на сторонние ресурсы с рекламной целью
